const useStyles = ({ showText, hideBackGround }) => {
	const styles = {
		main_container: `flex justify-center items-center absolute w-screen h-screen z-50 
		...
		author_text: 'text-shadow-5 text-right pr-10 pb-4',

		text_animation: `transition-opacity ease-linear duration-[2000ms] ${
